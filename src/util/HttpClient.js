...
export default class HttpClient
{
    ...
    static upload(url, filename, targetFilename = null, callback, callbackError)
    {
        ...
        if(targetFilename == null || targetFilename == filename)
            targetFilename = shortFilenames;
        ...
        body.append('file', {uri: filename, name: targetFilename, type: 'image/jpg'});
